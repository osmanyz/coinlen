...
module.exports.pending = function (user, payment) {
  email.sendEmail({
    to: user.email,
    subject: global.lang('Your Coinlen Subscription Payment is Pending!'),
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="esd-block-text es-p15b" align="left">
                                    <h2>Your Premium Membership Payment is Pending.</h2>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="imageContentLast">
                                    <img src="https://images.unsplash.com/photo-1566914263188-38aef193289c?ixlib=rb-1.2.1&auto=format&fit=crop&w=560&q=60" width="560" class="flexibleImage" style="max-width:560px;" />
                                </td>
                            </tr>
                            <tr>
                                <td class="esd-block-text es-p15t" align="left">
                                    <p>Your Coinlen membership payment is pending. Your billing information.</p>
                                </td>
                            </tr>
