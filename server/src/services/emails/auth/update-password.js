...
module.exports.updatePassword = function (user) {
  return email.sendEmail({
    to: user.email,
    subject: global.lang('Your password has been updated'),
    html: template(user),
  });
};
    ...
    <tbody>
        <tr>
            <td class="esd-block-text es-p15b" align="left">
                <h2>Your Coinlen account password has been successfully updated.</h2>
            </td>
        </tr>
        <tr>
            <td class="esd-block-text es-p15t" align="left">
                <p>Hello, ${user.name}</p>
                <p>Your password update has been successfully completed. If you think you have not done this, please check your information.</p>
            </td>
        </tr>
        <tr>
